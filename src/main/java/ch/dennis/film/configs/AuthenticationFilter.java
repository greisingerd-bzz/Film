...
public class AuthenticationFilter implements ContainerRequestFilter {
    ...
    private boolean isUserAllowed(final String username, final String password, final Set<String> rolesSet) {
        if (username.equals("admin") && password.equals("adminpass") && rolesSet.contains("ADMIN")) {
            return true;
        } else if (username.equals("poster") && password.equals("posterpass") && rolesSet.contains("POSTER")) {
            return true;
        }
        return false;
    }
